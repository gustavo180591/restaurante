  ...
  <div class="container mx-auto px-6">
    <div class="flex flex-col md:flex-row items-center">
      <div class="md:w-1/2 mb-10 md:mb-0 md:pr-10">
        ...
        <a href="#" class="text-amber-600 font-semibold hover:text-amber-700 text-lg flex items-center">
    ...
    <div class="grid md:grid-cols-4 gap-8">
      ...
      <div>
        ...
        <ul class="space-y-2">
          ...
          <li><a href="#reservas" class="text-gray-400 hover:text-white transition">Reservas</a></li>
