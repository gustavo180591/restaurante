...
<div class="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
  <div class="max-w-7xl mx-auto">
    ...
    <div class="text-center mb-12">
      <h1 class="text-4xl font-bold text-gray-900 mb-4">Contáctenos</h1>
      <p class="text-xl text-gray-600 max-w-2xl mx-auto">Estamos aquí para ayudarte. Envíanos un mensaje y te responderemos lo antes posible.</p>
    </div>
    ...
    <div class="bg-white shadow-xl rounded-lg overflow-hidden">
      <div class="grid grid-cols-1 lg:grid-cols-2">
          ...
          <form on:submit|preventDefault={handleSubmit} class="space-y-6">
            ...
            <div class="pt-2">
              <button
                ...
                class="w-full md:w-auto bg-amber-600 hover:bg-amber-700 text-white font-bold py-3 px-8 rounded-md transition duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {#if isSubmitting}
        ...
        <div class="bg-gray-50 p-8 flex flex-col justify-between">
          <div>
            ...
            <div class="mt-8">
              ...
              <div class="flex space-x-4">
                <a href="#" class="text-gray-500 hover:text-amber-600 transition duration-300">
          ...
          <div class="mt-8 rounded-lg overflow-hidden">
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d105073.44379606317!2d-58.5035105!3d-34.6156624!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95bcca3b4ef90cbd%3A0xa0b3812e88e88e87!2sBuenos%20Aires%2C%20CABA!5e0!3m2!1ses-419!2sar!4v1633028665934!5m2!1ses-419!2sar" 
              width="100%" 
              height="200" 
              style="border:0;" 
              allowfullscreen="" 
      ...
      <div class="p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-7 gap-6">
          {#each [
            ...
            { day: 'Viernes', hours: '11:00 AM - 12:00 AM' },
